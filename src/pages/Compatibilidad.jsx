...
export default function Compatibilidad() {
  ...
  const handleVerifyImei = async () => {
    setLoading(true);
    await verifyImei(imei, setLoading);
    setLoading(false);
  };
              ...
              <Row className="align-items-center">
                ...
                <Col md={6}>
                  ...
                  <p>
                    ...
                    desde tu dispositivo móvil para obtener el IMEI o busca una
                    etiqueta debajo de la batería de tu teléfono.
                  </p>
                  <Form>
                    ...
                    <div className="text-center">
                      <Button
                        ...
                        disabled={loading}
                      >
                        {loading ? <Spinner size="sm" animation="border" /> : "Verificar IMEI"}
                      </Button>
                    </div>
                  </Form>
                </Col>
