...
import { faFacebook, faXTwitter, faWhatsapp, faInstagram, faSnapchat, faTelegram, faFacebookMessenger, faTwitter } from '@fortawesome/free-brands-svg-icons';
                        ...
                        <Row>
                            <Col>
                                ...
                                <main>
                                    ...
                                    {/* <section className='pt-5'>
                                        ...
                                        <Accordion defaultActiveKey={null} flush>
                                            ...
                                            <Accordion.Item eventKey="1">
                                                ...
                                                <Accordion.Body>
                                                    <p className='text-body-secondary fs-6 text-justify'>
                                                        <ul className='text-body-secondary fs-6 text-justify'>
                                                            <li>
                                                                Si el usuario desea adquirir un E-SIM, el proceso de compra es el siguiente:
                                                                <ul>
                                                                    <li>Nombre completo de cliente.</li>
                                                                    <li>Correo electronico.</li>
                                                                    <li>Número de contacto.</li>
                                            ...
                                            <Accordion.Item eventKey="2">
                                                ...
                                                <Accordion.Body>
                                                    <p className='text-body-secondary fs-6 text-justify'>
                                                        Te invitamos que revises <Link to="/contrato-adhesion-profeco" target="_blank">contrato de adhesión con Profeco.</Link>     
                                                    </p>
                                                </Accordion.Body>
                                            </Accordion.Item>
                                        </Accordion>
                                    ...
                                    {/* <section className='pt-5'>
                                        <h2 className='fw-bold conditions-title display-5 text-center text-lg-start'>Realización de Trámites</h2>
                                         <Accordion defaultActiveKey={null} flush>
                                            <Accordion.Item eventKey="0">
                                                <Accordion.Header>
                                                ...
                                                <Accordion.Body>
                                                    <p className='text-body-secondary fs-6 text-justify'>
                                                        En TUIS nuestros planes no son forzosos. Si deseas cancelar comunícate con uno de nuestros asesores para solicitar la baja del servicio. 
                                                        Contacto TUIS enlace <a href="https://wa.link/8ixi0l">WhatsApp</a> horario de atencion Lunes a Viernes de 9am a 6pm y Sabado de 9am a 2pm.
                                                    </p>
                                                </Accordion.Body>
                                            ...
                                            <Accordion.Item eventKey="1">
                                                <Accordion.Header>
                                                    <h4 className='mt-4 fw-bold privacy-subtitle fs-4 text-center text-lg-start'>Problemas con mi servicio</h4>
                                                </Accordion.Header>
                                                <Accordion.Body>
                                                    <p className='text-body-secondary fs-6 text-justify'>
                                                        Estamos para apoyarte Contacto TUIS enlace <a href="https://wa.link/8ixi0l">WhatsApp</a> horario de atencion Lunes a Viernes de 9am a 6pm y Sabado de 9am a 2pm.
                                                    </p>
                                                </Accordion.Body>
                                            </Accordion.Item>
                                            ...
                                            <Accordion.Item eventKey="2">
                                                ...
                                                <Accordion.Body>
                                                    <p className='text-body-secondary fs-6 text-justify'>
                                                        En caso de robo y extravió se recomienda ejecutar lo antes posible la suspensión de la linea para evitar el mal uso de esta. 
                                                        Para suspender tu línea contáctanos: Contacto TUIS enlace WhatsApp horario de atencion Lunes a Viernes de 9am a 6pm y Sabado de 9am a 2pm.
                                                    </p>
                                                </Accordion.Body>
                                            </Accordion.Item>
                                    ...
                                    <p className='text-body-secondary fs-6 mt-5 pt-5 text-end'>
                                        <span className='fw-bold'>Última actualización:</span> Septiembre 2025 
                                    </p>
                                </main>
                            </Col>
                        </Row>
