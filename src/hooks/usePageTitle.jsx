...
const usePageTitle = () => {
  ...
  useEffect(() => {
    ...
    const titles = {
      ...
      "/paquetes/paquetes-basicos": "Paquetes Básicos | Tuis",
      "/paquetes/paquetes-tuisty": "Paquetes Tuisty | Tuis",
      "/paquetes/paquetes-trimestrales": "Paquetes Trimestrales | Tuis",
      "/paquetes/paquetes-semestrales": "Paquetes Semestrales | Tuis",
      "/paquetes/paquetes-anuales": "Paquetes Anuales | Tuis",
