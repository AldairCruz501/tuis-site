                        ...
                        <JackInTheBox delay={index * 800}>
                            ...
                            {index === 0 ? (
                                ...
                                <Row>
                                    ...
                                    <Col md={6} className="text-center py-1 py-sm-2 py-lg-4">
                                    <p className="my-0 text-secondary fs-6">Incluye</p>
                                ...
                                <Card.Body>
                                    ...
                                    <Button
                                    className="plan-button text-uppercase fw-bold fst-italic p-1 px-4 rounded-pill fs-4 border-light"
                                    onClick={() => {
                                        // Este botón redirecciona al carrito de compras
                                    }}
                                    >
